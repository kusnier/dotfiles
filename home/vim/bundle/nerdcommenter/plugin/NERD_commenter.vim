...
if g:NERDCreateDefaultMappings
    call s:CreateMaps('<plug>NERDCommenterComment',    '<leader>ncc')
    call s:CreateMaps('<plug>NERDCommenterToggle',     '<leader>nc<space>')
    call s:CreateMaps('<plug>NERDCommenterMinimal',    '<leader>ncm')
    call s:CreateMaps('<plug>NERDCommenterSexy',       '<leader>ncs')
    call s:CreateMaps('<plug>NERDCommenterInvert',     '<leader>nci')
    call s:CreateMaps('<plug>NERDCommenterYank',       '<leader>ncy')
    call s:CreateMaps('<plug>NERDCommenterAlignLeft',  '<leader>ncl')
    call s:CreateMaps('<plug>NERDCommenterAlignBoth',  '<leader>ncb')
    call s:CreateMaps('<plug>NERDCommenterNest',       '<leader>ncn')
    call s:CreateMaps('<plug>NERDCommenterUncomment',  '<leader>ncu')
    call s:CreateMaps('<plug>NERDCommenterToEOL',      '<leader>nc$')
    call s:CreateMaps('<plug>NERDCommenterAppend',     '<leader>ncA')
