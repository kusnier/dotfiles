...
" vim: tw=0 ts=4 sw=4
" Vim color file
" Maintainer:Sebastian Kusnierczyk
...
hi FoldColumn		ctermfg=Black ctermbg=LightGrey guibg=DarkGrey guifg=Black
hi Folded			ctermfg=Black ctermbg=LightGrey guifg=Black
...
hi Type				ctermfg=blue  guifg=#1E90FF
